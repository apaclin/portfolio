...
<Breakout maxWidth="1440px">
  <figure class="not-prose m-0">
    ...
    <figcaption class="case-image__caption mt-2 text-left text-sm leading-[1.4] text-[var(--color-text-muted)]">Three axes, three vocabularies. Only exceptions carry functional colour.</figcaption>
  </figure>
</Breakout>
...
<Breakout maxWidth="1440px">
  <figure class="not-prose m-0">
    ...
    <figcaption class="case-image__caption mt-2 text-left text-sm leading-[1.4] text-[var(--color-text-muted)]">Five entities, five cycles. Exception logic remains consistent across all entities.</figcaption>
  </figure>
</Breakout>
