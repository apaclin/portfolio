...
<Breakout maxWidth="960px">
  <Image src={exceptionDetail1} alt="Exception detail screen with side-by-side document comparison" class="w-full h-auto object-contain mx-auto" />
</Breakout>
...
<Breakout maxWidth="960px">
  <Image src={vendor} alt="Vendor profile with payment and exception context" class="w-full h-auto object-contain mx-auto" />
</Breakout>
