...
<Carousel
  ...
  items={[
    ...
    },
    {
      ...
      alt: "Exception queue grouped by confidence for triage",
    },
  ]}
/>
...
<Breakout maxWidth="960px">
  <Image src={exceptionQueue2} alt="Exception queue with similar exceptions grouped for bulk resolution, outliers excluded" class="w-full h-auto object-contain mx-auto" />
</Breakout>
...
<Walkthrough
  ...
  alternateStep={2}
  alt="Exception detail screen with side-by-side document comparison"
  title="Anatomy of an exception"
  description="Every block on this screen answers one question the AP specialist would otherwise chase across tabs, emails and side channels."
