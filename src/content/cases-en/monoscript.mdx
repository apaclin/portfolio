...
This is a live interactive prototype: feel free to test it out, create a script, organize it into a folder, test the collapse animation, select objects, move items to trash, and explore the UI.
